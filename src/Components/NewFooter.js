    ...
    return (
        <>
            <div className="mt-0 bg-black text-amber-100 relative bottom-0 w-full md:grid md:grid-cols-3">
                ...
                <div className='md:ml-5 py-4 sm:py-8 text-center md:text-left '>
                    <img className="rounded-2xl " src={image} alt='Logo' />
                    <p className='mt-5 text-sm sm:text-lg'>© Copyright DaMovieCritik 2023</p>

                </div>

                <div className="text-center sm:py-8 text-sm sm:text-lg">
                ...
                <div className="text-center md:text-right py-4 sm:py-8 text-sm sm:text-lg md:pr-8">
