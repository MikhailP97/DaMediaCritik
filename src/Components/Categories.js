...
function Categories() {
    ...
    //const movies_genre_url = "https://api.themoviedb.org/3/discover/movie?primary_release_date.gte=2022-12-10&primary_release_date.lte=2022-12-31&with_genres=28&api_key=7b6c4ae4c36a426a868e59064d239972";
  ...
  return (
    <>
        ...
        <div align='left' style={{margin:+20}}>
            <h1 className='text-4xl text-white py-0 font-bold'>Films par catégories</h1>
        </div>
