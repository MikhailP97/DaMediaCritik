...
export default function ConnexionhtmlForm() {
        return (
            <div>
                ...
                <div >
                    ...
                    <form className="flex flex-col items-center">
                        ...
                        <label htmlFor="email" className="mt-10 mb-5 text-white text-lg opacity-80">Identifiant (email) </label>
                        <input className="py-2 px-2 w-80 rounded-md bg-stone-100" type="email" placeholder='Votre adresse mail...' />

                        <label htmlFor="password" className="mt-10 mb-5 text-white text-lg opacity-80">Mot de passe </label>
                        <div className="flex flex-row items-center">
                            <input className="py-2 px-2 w-80  rounded-md bg-stone-100" type="password" placeholder="Votre mot de passe..." />
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className=" invert w-6 h-6">
