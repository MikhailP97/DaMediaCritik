...
export default function ConnexionForm() {
    ...
    return (
        ...
        <>
            ...
            <form className=" bg-stone-800 shadow-md  w-2/3 flex flex-col pb-20 pt-10 m-auto rounded-xl ">
                <div>
                    <label htmlFor="email" className="block mt-10 mb-5 text-white text-lg opacity-98">Identifiant (email) </label>
