    ...
    return (
        <>
            ...
            <div className=" mt-20 md:mt-0 relative flex py-5 items-center">
                ...
                <span className="flex-shrink my-10 mx-4 text-amber-50 text-2xl font-bold">Nous contacter</span>
                <div className="flex-grow border-t mr-20 border-amber-50"></div>
            </div>


            <form className=" bg-stone-800 shadow-md w-full sm:w-2/3 lg:w-1/2 xl:w-1/3 flex flex-col pb-5 pt-10 m-auto mb-10 sm:rounded-xl" onSubmit={handleSubmit}>
                ...
                <div className=" flex flex-col m-auto w-5/6 ">
                    <label htmlFor="date" className=" mt-10 mb-5 text-white text-lg opacity-98">Message <span className="text-amber-300">*</span> :</label>
                ...
                <div className="flex justify-center">
                    ...
                    <button type="submit" className=" py-4 px-12 sm:py-1 sm:px-5 mb-14 shadow-md shadow-stone-300/50 bg-stone-900  mt-10 rounded-md text-lg text-white font-semibold border-2 border-white hover:text-amber-300 hover:border-amber-300 hover:shadow-amber-300/50  ">Envoyer</button>
                </div>
