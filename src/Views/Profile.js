                    ...
                    favorites?.length ? favorites.map(fav => {   
                            return(                                                            
                                    <div className="flex flex-col items-center">       
                                      <div className="text-center" onClick={() => navigate(`/page-film/${fav.movieId}`)}>  
                                        <img className="rounded-md w-48" id="favoris" src={`https://image.tmdb.org/t/p/original/${fav.movieImg}`} alt="affiche de film" />                                                      
                                        <p className="text-lg mt-2">{fav.movieTtile}</p>
                                      </div>
                                      <div className="text-center">
                                        <button className="text-base text-red-700 mt-1" onClick={() => deleteFavorite(fav.id)}>Supprimer</button>
                                      </div>
                                    </div> 
                            )
                ...
                return (
                  <>
                    <div className="text-left" key={crt.id}>
                      <p className="text-lg text-amber-500 underline">{crt.movieTtile}</p>
