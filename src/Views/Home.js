...
function Home() {
  ...
  return (
    <div>
      <div id = "band" className="mt-20 md:mt-0 px-3 md:px-0 text-center text-4xl md:text-5xl text-white py-20 font-bold bg-gradient-to-r from-stone-700 to-stone-900">
